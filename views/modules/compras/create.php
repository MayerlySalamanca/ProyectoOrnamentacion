                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="post" id="<?= $nameForm ?>" name="<?= $nameForm ?>"
                                    ...
                                    $dataVenta = null;
                                    if (!empty($_GET['id'])) {
                                        $dataVenta = ComprasController::searchForID(["id" => $_GET['id']]);
                                    ...
                                    ?>
                                    <a href="../compras" role="button" class="btn btn-danger">Regresar</a>
                                </form>
                            </div>
                        </div>
                        <!-- /.card -->
                                    ...
                                    <div class="col">
                                        <table id="tblDetalleProducto"
                                            ...
                                            if (!empty($dataCompra) and !empty($dataCompra->getId())) {
                                                $arrDetalleCompras = Fabricacion::search("SELECT * FROM ornamentacion.fabricacion WHERE compra_id = ".$dataCompra->getId());
                                                if(count($arrDetalleCompras) > 0) {
                                                    /* @var $arrDetalleCompras Fabricacion[] */
