                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="post" id="<?= $nameForm ?>" name="<?= $nameForm ?>"
                                    ...
                                    <div class="form-group row">
                                        <label for="nombres" class="col-sm-2 col-form-label">numero de Fabricacion</label>
                                        <div class="col-sm-10">
                                            <input required type="number" class="form-control" id="nombres" name="nombres"
                                                   placeholder="Ingrese el numero Fabricacion" value="<?= $frmSession['nombres'] ?? '' ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required type="number" class="form-control" id="nombres" name="nombres"
                                                   placeholder="Ingrese la cantidad" value="<?= $frmSession['nombres'] ?? '' ?>">
                                        </div>
                                    </div>
